...
console.log('Task 2.1 - Image src:', sampleImage.getAttribute('src'));

// Task 2.2: Select the link (id="sample-link") and log its 'href' attribute
const sampleLink = document.getElementById('sample-link');
console.log('Task 2.2 - Link href:', sampleLink.getAttribute('href'));
...
console.log('Task 3.1 - Highlight elements:', highlights);
...
listItems.forEach((item, index) => {
    console.log(`Task 3.3 - Item ${index + 1}:`, item.textContent.toUpperCase());
});
...
console.log('Bonus - Number of children in container:', container.children.length);
